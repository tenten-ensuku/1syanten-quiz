...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  createQuestion(
    ...
    "連続形が無いただのヘッドレス2型。78ｐ、34ｓのタテヨコＯＫ。",
    ["ヘッドレス2型"]
  ),
  createQuestion(
    "①-2",
  ...
  createQuestion(
    ...
    "隙間の無い連続形22344ｍ、34556ｓの受け入れは左隣から右隣まで。",
    ["ヘッドレス2型"]
  ),
  createQuestion(
    "①-4",
    "2234m6788p34556s",
    ["2m", "5m", "5p", "8p", "4s", "7s"],
    "□×亜両面2234ｍ、6788ｐの受け入れに注意。ヘッドレス１型なので34556ｓの連続形は関係なし。",
    ["ヘッドレス1型"]
  ),
  createQuestion(
    "①-5",
  ...
  createQuestion(
    ...
    "隙間の無い連続形11223ｍと12234ｓの受け入れは左隣から右隣まで。",
    ["ヘッドレス2型"]
  ),
  createQuestion(
    "①-7",
    ...
    "□□×（7枚形）1234567ｍとリャンカン246ｓの受け入れに注意。",
    ["ヘッドレス1型"]
  ),
  createQuestion(
    "①-8",
    ...
    "隙間のある連続形34557ｐは左隣から右隣までとはならないので注意。12345678ｍの部分は12345ｍと45678ｍの2通りの連続形に見られる。",
    ["ヘッドレス2型"]
  ),
  createQuestion(
    "②-1",
